...
?>
    <div class="contacts visible <?= implode(' ', $contactsClasses) ?> permanent" id="contacts">
        <div class="container">
            <span class="menu"><a class="internal" href="https://www.drdplus.info"><img class="home"
            ...
            <span class="contact"><a target="_blank" class="facebook-contact" href="https://www.facebook.com/drdplus.info">Facebook</a></span>
        </div>
    </div>
